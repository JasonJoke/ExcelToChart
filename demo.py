...
def deal_file_draw():
    for i in range(len(dealed_path)):
        ...
        plt.plot(x, all_y[1], color='blue', marker='o', label='min')
        plt.plot(x, all_y[2], color='green', marker='*', label='avg')
        ...
        plt.plot(x, all_y1[1], color='blue', marker='o', label='min')
        plt.plot(x, all_y1[2], color='green', marker='*', label='avg')
        plt.legend(bbox_to_anchor=(0.9, 1), framealpha=0.2)
        ...
        plt.plot(x, all_y2[1], color='blue', marker='o', label='min')
        plt.plot(x, all_y2[2], color='green', marker='*', label='avg')
        plt.legend(bbox_to_anchor=(0.9, 1), framealpha=0.2)
